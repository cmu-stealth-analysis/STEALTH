...
for step in runSequence:
    if (step == "data"):
        ...
        # for signalType in ["signal", "control"]: # meant for QCD-only selections, in which statistics in the loose signal bin are hopelessly poor
            ...
            # sourceData_GJetMC="{eP}/store/user/lpcsusystealth/selections/combined_DoublePhoton{s_s}/merged_selection_MC_QCD17_2017_{sT}.root!{eP}/{aEOD}/PUWeights_QCD_17.root,{eP}/store/user/lpcsusystealth/selections/combined_DoublePhoton{s_s}/merged_selection_MC_QCD18_2018_{sT}.root!{eP}/{aEOD}/PUWeights_QCD_18.root".format(eP=stealthEnv.EOSPrefix, aEOD=analysisEOSOutputDirectory, s_s=selection_suffix, sT=signalType)
            # sourceData_GJetMC="{eP}/store/user/lpcsusystealth/selections/combined_DoublePhoton{s_s}/merged_selection_MC_GJet16_2016_{sT}.root!{eP}/{aEOD}/PUWeights_GJet_16.root,{eP}/store/user/lpcsusystealth/selections/combined_DoublePhoton{s_s}/merged_selection_MC_GJet17_2017_{sT}.root!{eP}/{aEOD}/PUWeights_GJet_17.root,{eP}/store/user/lpcsusystealth/selections/combined_DoublePhoton{s_s}/merged_selection_MC_GJet18_2018_{sT}.root!{eP}/{aEOD}/PUWeights_GJet_18.root,{eP}/store/user/lpcsusystealth/selections/combined_DoublePhoton{s_s}/merged_selection_MC_QCD17_2017_{sT}.root!{eP}/{aEOD}/PUWeights_QCD_17.root,{eP}/store/user/lpcsusystealth/selections/combined_DoublePhoton{s_s}/merged_selection_MC_QCD18_2018_{sT}.root!{eP}/{aEOD}/PUWeights_QCD_18.root".format(eP=stealthEnv.EOSPrefix, aEOD=analysisEOSOutputDirectory, s_s=selection_suffix, sT=signalType)
