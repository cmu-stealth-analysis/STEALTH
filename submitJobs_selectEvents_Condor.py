...
while endCounter < nEvts:
    ...
    jdlCreationCommand = "./createJDL_eventSelection.sh {workingDirectory}/{jdlFileName} {inputFilePath} {outputFileName} {startCounter} {endCounter} {selectionType} {HLTBit} {JECUncertainty} {outputDirectory} {jdlLogPrefix}".format(workingDirectory=inputArguments.workingDirectory, jdlFileName=jdlFileName, inputFilePath=inputArguments.inputFilePath, outputFileName=outputFileName, startCounter=startCounter, endCounter=endCounter, selectionType=inputArguments.photonSelectionType, HLTBit=inputArguments.HLTPhotonBit, JECUncertainty=inputArguments.JECUncertainty, outputDirectory=inputArguments.outputDirectory, jdlLogPrefix=jdlLogPrefix)
