...
drawContoursForLegend(commonOffset, 0.03, 0.745, 0.01, width_expectedContours_middle, style_expectedContours_middle, color_expectedContours, width_expectedContours_topBottom, style_expectedContours_topBottom, color_expectedContours, 0.59)
...
if inputArguments.plotObserved:
    drawContoursForLegend(commonOffset, 0.03, 0.705, 0.01, width_observedContours_middle, style_observedContours_middle, color_observedContours, width_observedContours_topBottom, style_observedContours_topBottom, color_observedContours, 0.5775)
    latex.SetTextSize(0.03)
