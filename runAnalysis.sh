...
INPUTFILESLIST_CONTROL="${INPUTDATADIR_CONTROL}/merged_selection_data_201*_control_fakefake.root;${INPUTDATADIR_CONTROL}/merged_selection_data_201*_control_mediumfake.root"
