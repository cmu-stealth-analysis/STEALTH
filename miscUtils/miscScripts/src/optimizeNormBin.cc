...
int main(int argc, char* argv[]) {
  ...
  std::cout << "Configuration parameters written to file: " << (options.outputFolder + "/fitParameters_unbinnedFit_" + options.yearString + "_" + options.identifier + "_" + options.selection + ".dat") << std::endl;
