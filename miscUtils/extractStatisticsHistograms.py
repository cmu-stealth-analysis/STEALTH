...
inputArgumentsParser.add_argument('--outputFolder', default="{aR}/IDEfficiencies".format(aR=stealthEnv.analysisRoot), help='Path to folder in which to store output plots.',type=str)
...
def plotAndSaveIDEfficiencies(efficiencies, outputFolder):
    ...
    for nJetsBin in range(2, 7):
        ...
        signal_graphObject.SetMinimum(-0.15)
        ...
        ROOT.gPad.Update()
        legendEntry = legend.AddEntry(h_efficiency_signal_loose, "loose signal")
