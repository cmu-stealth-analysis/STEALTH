...
def plotAndSaveIDEfficiencies(name_signal, name_control, outputFilePath):
...
for nJetsBin in range(2, 7):
    ...
    plotAndSaveIDEfficiencies(name_signal=signalSource, name_control=controlSource, outputFilePath="{oF}/efficiencies_{n}Jets.png".format(oF=inputArguments.outputFolder, n=nJetsBin))
