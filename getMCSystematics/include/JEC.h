...
int nGeneratedEventsPerBin, nGluinoMassBins, nNeutralinoMassBins;
long maxMCEvents;
double sTMin_normWindow, sTMax_normWindow, sTStartMainRegion, integratedLuminosity, minGluinoMass, maxGluinoMass, minNeutralinoMass, maxNeutralinoMass;
