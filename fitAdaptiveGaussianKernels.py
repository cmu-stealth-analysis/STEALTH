...
for kernelType in enabledKernels:
    ...
    for rho in enabledRhos:
        ...
        for counter in range(0, inputArguments.nToyMCs):
            ...
            toyExtendedPDF = ROOT.RooExtendPdf(toyExtendedPDFName, toyExtendedPDFName, rooKernel_PDF_Fits[kernelType][rhoStr], rooVar_nEventsInNormRegion, "restricted_sTRange")
