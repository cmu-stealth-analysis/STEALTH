...
while endCounter < nEvts:
    ...
    commandToCall = "bsub -q {queue} submitJobs_selectEvents_Helper.sh {inputFilePath} {outputFilePath} {startCounter} {endCounter} {photonSelectionType} {logFilePath}".format(queue=inputArguments.queue, inputFilePath=inputArguments.inputFilePath, outputFilePath=outputFilePath, startCounter=startCounter, endCounter=endCounter, photonSelectionType=inputArguments.photonSelectionType, logFilePath=logFilePath)
