...
dataAndKernelsLegend = ROOT.TLegend(0.55, 0.6, 0.95, 0.91)
ROOT.gStyle.SetLegendTextSize(0.055)
...
sTFrames["rhoValues"]["dataAndKernels"].GetXaxis().SetLabelSize(0.055)
sTFrames["rhoValues"]["dataAndKernels"].GetXaxis().SetTitleSize(0.055)
sTFrames["rhoValues"]["dataAndKernels"].GetYaxis().SetLabelSize(0.055)
sTFrames["rhoValues"]["dataAndKernels"].GetYaxis().SetTitleSize(0.055)
sTFrames["rhoValues"]["dataAndKernels"].GetYaxis().SetTitleOffset(0.875)
ROOT.gPad.Update()
