...
for selectionType in selectionTypesToRun:
    ...
    for year in yearsToRun:
        ...
        for selectionRegion in ["signal", "signal_loose", "control_fakefake", "control_singlemedium", "control_singleloose", "control_singlefake"]:
            ...
            mergeSelectionCommand = "eventSelection/bin/mergeEventSelections inputFilesList={iFL} outputFolder={oF} outputFileName={oFP} mergeCounters=true".format(iFL=inputFilesList_selection, oF=outputFolder, oFP=outputFilePath)
            MCBKGMatch = re.match(r"^MC_(EMEnrichedGJetPt|HighHTQCD|GJetHT)([0-9]*)(|_singlephoton)_([0-9]*)$", selectionType)
            if MCBKGMatch:
                full_match = MCBKGMatch.group(0)
                dataset_id = MCBKGMatch.group(1)
...
for selectionType in selectionTypesToRun_Step2:
    ...
    for year in yearsToRun:
        ...
        for selectionRegion in ["signal", "signal_loose", "control_fakefake", "control_singlemedium", "control_singleloose", "control_singlefake"]:
            ...
            outputFolder = "{eP}/{sER}/selections/combined_DoublePhoton{oI}".format(eP=stealthEnv.EOSPrefix, sER=stealthEnv.stealthEOSRoot, oI=optional_identifier)
            outputFilePath = "merged_selection_{t}{oIS}_{y}_{sRS}.root".format(t=selectionType, oIS=overallIdentificationString, y=year, sRS=selectionRegionString)
            mergeSelectionCommand = "eventSelection/bin/mergeEventSelections inputFilesList={mS2FP} outputFolder={oF} outputFileName={oFP} mergeCounters=false".format(mS2FP=mergeStep2FilePath, oF=outputFolder, oFP=outputFilePath)
            multiProcessLauncher.spawn(shellCommands=mergeSelectionCommand, optionalEnvSetup="cd {sR} && source setupEnv.sh".format(sR=stealthEnv.stealthRoot), logFileName="mergeLog_selection_{t}{oIS}_{y}_{sRS}.log".format(t=selectionType, oIS=overallIdentificationString, y=year, sRS=selectionRegionString), printDebug=True)
            monitoringNeeded = True
        if isMC:
            if monitoringNeeded:
...
# ./runSelectionMerge.py --disableJetSelection --selectionsToRun "MC_hgg" && reset && ./runSelectionMerge.py --selectionsToRun "data" && reset && ./runSelectionMerge.py --selectionsToRun "MC_DiPhotonJetsBox" && reset && ./runSelectionMerge.py --selectionsToRun "MC_GJetHT16" && reset && ./runSelectionMerge.py --selectionsToRun "MC_GJetHT17" && reset && ./runSelectionMerge.py --selectionsToRun "MC_GJetHT18" && reset && ./runSelectionMerge.py --selectionsToRun "MC_HighHTQCD16" && reset && ./runSelectionMerge.py --selectionsToRun "MC_HighHTQCD17" && reset && ./runSelectionMerge.py --selectionsToRun "MC_HighHTQCD18" && reset && ./runSelectionMerge.py --selectionsToRun "data_singlephoton" && reset && ./runSelectionMerge.py --selectionsToRun "MC_DiPhotonJetsBox_singlephoton" && reset && ./runSelectionMerge.py --selectionsToRun "MC_GJetHT16_singlephoton" && reset && ./runSelectionMerge.py --selectionsToRun "MC_GJetHT17_singlephoton" && reset && ./runSelectionMerge.py --selectionsToRun "MC_GJetHT18_singlephoton" && reset && ./runSelectionMerge.py --selectionsToRun "MC_HighHTQCD16_singlephoton" && reset && ./runSelectionMerge.py --selectionsToRun "MC_HighHTQCD17_singlephoton" && reset && ./runSelectionMerge.py --selectionsToRun "MC_HighHTQCD18_singlephoton" && reset && ./runSelectionMerge.py --selectionsToRun "MC" && reset && echo "merge done"

# ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --disableJetSelection --selectionsToRun "MC_hgg" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "data" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_DiPhotonJetsBox" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_GJetHT16" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_GJetHT17" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_GJetHT18" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_HighHTQCD16" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_HighHTQCD17" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_HighHTQCD18" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "data_singlephoton" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_DiPhotonJetsBox_singlephoton" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_GJetHT16_singlephoton" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_GJetHT17_singlephoton" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_GJetHT18_singlephoton" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_HighHTQCD16_singlephoton" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_HighHTQCD17_singlephoton" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC_HighHTQCD18_singlephoton" && reset && ./runSelectionMerge.py --optionalIdentifier "HigherJetPTThreshold" --selectionsToRun "MC" && reset && echo "merge done for higher jet pt threshold"
